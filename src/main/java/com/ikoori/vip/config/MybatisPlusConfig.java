...
import com.ikoori.vip.config.properties.DruidProperties;
import com.ikoori.vip.config.properties.MutiDataSourceProperties;
...
@MapperScan(basePackages = {"com.ikoori.vip.modular.*.dao", "com.ikoori.vip.common.persistence.dao"})
