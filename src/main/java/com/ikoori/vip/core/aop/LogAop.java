package com.ikoori.vip.core.aop;
...
import com.ikoori.vip.core.support.HttpKit;
import com.ikoori.vip.core.util.Contrast;
...
public class LogAop {
    ...
    @Pointcut(value = "@annotation(com.ikoori.vip.common.annotion.log.BussinessLog)")
