...
public class DaoConfig {
    ...
    public void init() {
        this.daoPathTemplate = "\\src\\main\\java\\com\\ikoori\\vip\\modular\\" + contextConfig.getModuleName() + "\\dao\\{}Dao.java";
        this.xmlPathTemplate = "\\src\\main\\java\\com\\ikoori\\vip\\modular\\" + contextConfig.getModuleName() + "\\dao\\mapping\\{}Dao.xml";
