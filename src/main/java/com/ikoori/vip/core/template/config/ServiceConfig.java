package com.ikoori.vip.core.template.config;
...
public class ServiceConfig {
    ...
    public void init() {
        ...
        imports.add("com.ikoori.vip.modular." + contextConfig.getModuleName() + ".service.I" + contextConfig.getBizEnBigName() + "Service");
        this.serviceImplImports = imports;
        this.servicePathTemplate = "\\src\\main\\java\\com\\ikoori\\vip\\modular\\" + contextConfig.getModuleName() + "\\service\\I{}Service.java";
        this.serviceImplPathTemplate = "\\src\\main\\java\\com\\ikoori\\vip\\modular\\" + contextConfig.getModuleName() + "\\service\\impl\\{}ServiceImpl.java";
        this.packageName = "com.ikoori.vip.modular." + contextConfig.getModuleName() + ".service";
    }
